...
The product should be easy to understand. Considering we are building [0rbit](https://0rbit.co) the Decentralized Oracle infrastructure, our product should be easy to understand for the developers who will use it. The audience type should be considered while analyzing if people can understand.
...
%[https://www.youtube.com/watch?v=0lJKucu6HJc&t=1s] 
